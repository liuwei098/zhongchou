...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.availableActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><strong>Categories</strong><a href="#" class="add-all">'+$.ui.multiselect.locale.addAll+'</a></div>').appendTo(this.availableContainer);
